...
public class CleanUsurperRootComponentsTest {
  ...
  public void execute_deletes_children_tables_of_snapshots_when_root_of_snapshot_is_not_root() throws SQLException {
    String componentUuid = insertComponent(Scopes.FILE, Scopes.FILE, 12L, "U1", "U2");
    Long snapshotId = insertSnapshot(dontCare(), 12L);
    insertProjectMeasures(componentUuid, snapshotId);
